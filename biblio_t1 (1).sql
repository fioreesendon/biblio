...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2025 a las 22:20:23
...
(22, 'General', 'Cartel con plantilla 4', 'Este es un ejemplo con diseño 4', NULL, 4, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(23, 'General', 'Cartel con plantilla 5', 'Este es un ejemplo con diseño 5', NULL, 5, NULL, NULL, 1, NULL, NULL, NULL, NULL),
(24, 'Ayuda', 'Tutorial para publicar', 'Sigue estos pasos para usar el sistema...', NULL, 0, NULL, NULL, 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `libros_d` (`id_libro`, `Autor`, `Titulo`, `edicion`, `año`, `origen`, `Area`, `Materia`, `Comentario`, `Archivo`, `tipo`, `video`, `audio`) VALUES
(3, 'Hermann Hesse', 'Demian', 'Papel', '1944', 'inglaterra', '', '', '', 'demian.pdf', '', NULL, NULL),
(4, 'Hermann Hesse', 'Lobo Estepario', 'Papel', '1943', 'Ingles', '', '', '', 'Hermann Hesse - El lobo estepario.pdf', '', NULL, NULL),
(6, 'Luis Alberto Spinetta', 'Guitarra Negra', 'Papel', '1943', 'Frances', '', '', '', 'Spinetta.pdf', '', NULL, NULL),
(7, 'Arthur Conan Doyle', 'El Mundo Perdido.pdf', '', '', '', '', '', '', 'Arthur Conan Doyle - El Mundo Perdido.pdf', 'Libro', NULL, NULL),
(9, 'ALdous Huxley', 'La isla', '', '', '', '', '', '', '', 'Libro', NULL, NULL),
(10, 'Karel Capek', 'La Guerra de las salamandras', '', '', '', '', '', '', 'Capek, Karel-La Guerra De Las Salamandras.pdf', 'Libro', NULL, NULL),
(11, 'Aldous Huxley', 'Contrapunto', '', '', '', '', '', '', 'Huxley, Aldous - Contrapunto.pdf', 'Libro', NULL, NULL),
(12, 'Lem Stanislaw', 'El Invencible', '', '', '', '', '', '', 'Lem, Stanislaw - El Invencible.pdf', 'Libro', NULL, NULL),
(13, 'Huxley Aldous', 'Las puertas de la percepcion', '', '', '', '', '', '', 'Huxley, Aldous-Las puertas de la percepcion.pdf', 'Libro', NULL, NULL),
(15, 'php.net', 'PHP orientado a objetos', 'documento ms word', '2016', 'Español', 'Informatica', 'programacion', '', 'php_poo.docx', 'Otros', NULL, NULL),
(16, 'Bach  Richard', 'Juan Salvador Gaviota', '', '', 'Español', 'Literatura', '', '', 'Bach, Richard - Juan Salvador Gaviota.pdf', 'Libro', NULL, NULL),
(17, 'Greene Graham', 'Nuestro Hombre en La Habana', '', '', 'Español', '', '', '', 'Greene, Graham-Nuestro Hombre en La Habana.pdf', 'Libro', NULL, NULL),
(20, 'Frank, Ana', 'El diario de Ana Frank', '', '', '', '', '', '', 'Frank, Ana - Diario.pdf', 'Libro', NULL, NULL),
(21, 'Aldous Huxley', 'El joven Arquímedes', '', '', 'Español', 'Cultura', 'Literatura', '', 'el_joven_arquímedes.pdf', 'Libro', NULL, NULL),
(22, 'George Orwell', 'El camino de Wigan Pier', '', '', 'Español', '', '', '', 'el_camino_de_wigan_pier.pdf', 'Libro', NULL, NULL),
(23, 'CakePHP Team', 'CakePHP Cookbook', '', '', 'Español', '', '', '', 'CakePHPCookbook.pdf', 'Libro', NULL, NULL),
(24, 'José Manuel Ruiz Gutiérrez ', 'Manual de Programacion Arduino', '', '', 'Español', '', '', '', 'Manual+Programacion+Arduino.pdf', 'Libro', NULL, NULL),
(27, 'Gogol Nikolai', 'Capote', '', '', 'Castellano', '', '', '', 'Gogol-N-EL_Capote.pdf', 'Libro', NULL, NULL),
(28, 'FIODOR DOSTOIEWSKI', 'Crimen y Castigo', '', '', 'español', 'sociales', 'Literatura', '', 'crimencastigo.pdf', 'Libro', NULL, NULL),
(29, 'Albert Einstein', 'Mis Creencias', '', '', '', '', '', '', 'Albert Einstein - Mis Creencias .pdf', 'Libro', NULL, NULL),
(30, 'UMBERTO ECO ', 'EL PENDULO DE FOUCAULT', '', '', '', '', '', '', 'Eco - El Péndulo de Foucault.pdf', 'Libro', NULL, NULL),
(31, 'Garcia Marquez, Gabrie', 'De Viaje Por Los Paises Socialistas', '', '', '', '', '', '', 'Garcia Marquez, Gabriel - De Viaje Por Los Paises Socialistas.pdf', 'Libro', NULL, NULL),
(32, 'Garcia Marquez, Gabrie', 'El Rastro de tu Sangre en la Nieve', '', '', '', '', '', '', 'Garcia Marquez, Gabriel - El Rastro de tu Sangre en la Nieve.pdf', 'Libro', NULL, NULL),
(33, 'INGENIEROS JOSE', 'Las Fuerzas Morales', '', '', '', '', '', '', 'INGENIEROS JOSE - Las Fuerzas Morales.pdf', 'Libro', NULL, NULL),
(34, 'Manfredi, Valerio Massimo', 'El Tirano', '', '', '', '', '', '', 'Manfredi, Valerio Massimo - El Tirano.pdf', 'Libro', NULL, NULL),
(35, 'Ernest Hemingway', 'Aguas primaverales', '', '', '', '', '', '', 'aguas_primaverales.pdf', 'Libro', 'libros_d/video_1764212447_ssstik.io_@candesendon_1745188573985.mp4', 'libros_d/audio_1764212470_WhatsApp Audio 2025-08-19 at 19.40.25.ogg'),
(36, 'Benito Pérez Galdós', 'el caballero encantado', '', '', '', '', '', '', 'el_caballero_encantado.pdf', 'Libro', NULL, NULL),
(37, 'Oscar Wilde', 'el retrato de dorian gray', '', '', '', '', '', '', 'el_retrato_de_dorian_gray.pdf', 'Libro', NULL, NULL),
(38, 'Wlliam Shakespeare', 'el sueño de una noche de verano', '', '', '', '', '', '', 'el_sueño_de_una_noche_de_verano.pdf', 'Libro', NULL, NULL),
(39, 'George Orwell', 'La hija del clérigo', '', '', '', '', '', '', 'la_hija_del_clérigo.pdf', 'Libro', NULL, NULL),
(40, 'Ernest Hemingway', 'Las nieves del Kilimanjaro', '', '', '', '', '', '', 'las_nieves_del_kilimanjaro.pdf', 'Libro', NULL, NULL),
(41, 'Aldous Huxley', 'Música en la noche', '', '', '', '', '', '', 'música_en_la_noche.pdf', 'Libro', NULL, NULL),
(42, 'Ernest Hemingway', 'Tener y No Tener', '', '', '', '', '', '', 'tener_y_no_tener.pdf', 'Libro', NULL, NULL),
(43, 'H. G. Wells', 'Tono – Bungay', '', '', '', '', '', '', 'tono-bungay.pdf', 'Libro', NULL, NULL),
(44, 'Ernest Hemingway', 'Tener y No Tener', '', '', '', '', '', '', 'tener_y_no_tener.pdf', 'Libro', NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `libro_f`
--

CREATE TABLE `libro_f` (
  `id_libro_f` int(11) NOT NULL,
...
(151, 'Luis', 'Perconti', 'Masculino', '', '', '', 'p_luisss@yahoo.com.ar', 'lp', '1234', 'administrador'),
...
(156, '', '', '', NULL, NULL, NULL, '1', '1', 'c4ca4238a0b923820dcc509a6f75849b', 'estudiante'),
(161, '', '', '', NULL, NULL, NULL, '2', '2', 'c81e728d9d4c2f636f067f89cc14862c', 'estudiante');
...
INSERT INTO `prestamos_libros` (`id`, `id_libro`, `id_persona`, `fecha_prestamo`, `fecha_devolucion`, `fecha_devolucion_real`, `estado`) VALUES
(1, 35, 153, '2025-11-26', '0000-00-00', '2025-11-26', 'devuelto'),
(2, 35, 153, '2025-11-26', '0000-00-00', '2025-11-26', 'devuelto'),
(3, 35, 153, '2025-11-26', '0000-00-00', '2025-11-26', 'devuelto');
...
CREATE TABLE `roles` (
  ...
  `descripcion` varchar(128) NOT NULL DEFAULT 'Puede :'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
--
-- Indices de la tabla `libro_f`
--
ALTER TABLE `libro_f`
  ADD PRIMARY KEY (`id_libro_f`);
...
--
ALTER TABLE `carteles`
  MODIFY `id_cartel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
-- AUTO_INCREMENT de la tabla `libro_f`
--
ALTER TABLE `libro_f`
  MODIFY `id_libro_f` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `prestamos`
  ADD CONSTRAINT `prestamos_ibfk_1` FOREIGN KEY (`id_libro_f`) REFERENCES `libro_f` (`id_libro_f`),
...
--
ALTER TABLE `prestamos_libros`
  ADD CONSTRAINT `prestamos_libros_ibfk_1` FOREIGN KEY (`id_libro`) REFERENCES `libros_d` (`id_libro`),
  ADD CONSTRAINT `prestamos_libros_ibfk_2` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id`);
COMMIT;
